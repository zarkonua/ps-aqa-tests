...
| UI-NOTE-07 | P1 | Positive | 🔴 gate — content is rendered | Note with distinctive content | View the note card | Content is visible and matches what was entered (broken mode blanks content → card shows empty) | notes-management.spec |
...
| Note content round-trips (data) | Data integrity over HTTP | API-NOTE-03 (🔴 gate) |
